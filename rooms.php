    ...
    <div class="row justify-content-md-center">
            <table class="table-device">
              ...
              if(isset($_SESSION['normalusername']))
              {
                ...
                $sql = "SELECT id, r_name FROM rooms";
                ...
                if ($result->num_rows > 0) {
                 ...
                 while($row = $result->fetch_assoc()) {
                  ...
                  echo "<tr><td>" . $count. "</td><td>" . $row["r_name"] . "</td><td><a href='edit_rooms.php?id=".$row["id"]."'>Edit </a><a href='Remove_rooms.php?id=".$row["id"]."'>Remove</a><br></td></tr>";
              }
              echo "</table>";
              } else { echo "0 results"; }
              $conn->close();
